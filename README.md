...
An example of positive sample generation is provided.  
Positive samples can be generated by running `Positive_Generation.py`.

### 4.train
After obtaining the three modalities and their corresponding positive samples, the model can be trained.
